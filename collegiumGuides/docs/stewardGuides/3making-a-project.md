...
- **Model Last Published:** Don't worry, this gets populated when you link a project to a BIM.
- **Model Last Synched with Collegium:** As above
- **Project Type:** select whether it is commercial, residential etc.
- **Project Subtype:** New build, renovation, or addition to existing building.
- **Project Phase:** Where are we in the development process? Are we still figuring it out, or are we actively building?
